...
├── tableau_performance_final_modele_ridge.xlsx
│
├── base_dossier_eco.csv       # Donnée locale, non publiée
├── base_model.csv             # Donnée locale, non publiée
├── dossier.csv                # Donnée locale, non publiée
├── ressources.csv             # Donnée locale, non publiée
└── temps.csv                  # Donnée locale, non publiée
```
